...
public class CAManager {
    ...
    private static Map<Class<? extends ConfigurationAttribute>, Class<? extends CARenderer>> map;
    ...
    private CAManager(){
        ...
        map.put(Numeric.class, CARenderer.class);
        map.put(Choice.class, CARenderer.class);
        map.put(FileList.class, CARenderer.class);
        map.put(Source.class, CARenderer.class);
        map.put(Text.class, CARenderer.class);
    }
     ...
     */
    public boolean registerCA(Class<? extends ConfigurationAttribute> caClass , Class<? extends CARenderer> rendererClass){
     ...
     */
    public Class<? extends CARenderer> getRenderer(ConfigurationAttribute ca){
