...
/**
 * Editable element dedicated to the R editor
 *
 * @author Sylvain PALOMINOS
 */
public class RElement extends AbstractEditableElement implements DocumentListener {

    private static final String TYPE = "RElement";
    private static final String SAVE_ID = "rEditorOutFile";
    private static final String R_EXT = "r";
    private static final String R_DESC = "R script (*.r)";
    private static final I18n I18N = I18nFactory.getI18n(RElement.class);
    private static final Logger LOGGER = LoggerFactory.getLogger(RElement.class);
    ...
    public void save() throws UnsupportedOperationException, EditableElementException {
        if(document != null) {
            if(getDocumentPathString().isEmpty()) {
                ...
                outfilePanel.addFilter(R_EXT, I18N.tr(R_DESC));
    ...
    public String toString() {
        if(documentPath != null) {
            ...
            return I18N.tr("Unsaved R script");
        }
    }
